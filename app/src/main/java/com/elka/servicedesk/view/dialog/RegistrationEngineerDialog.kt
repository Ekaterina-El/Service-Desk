...
import com.elka.servicedesk.databinding.RegistrationEngineerBinding
...
class RegistrationEngineerDialog(
	context: Context,
	val owner: LifecycleOwner,
	val viewModel: EngineersViewModel,
	private val listener: Listener
) : Dialog(context) {
	private lateinit var binding: RegistrationEngineerBinding
	...
	private fun initDialog() {
		binding = RegistrationEngineerBinding.inflate(LayoutInflater.from(context))
		binding.apply {
			master = this@RegistrationEngineerDialog
			lifecycleOwner = this@RegistrationEngineerDialog.owner
			viewModel = this@RegistrationEngineerDialog.viewModel
			divisionsAdapter = this@RegistrationEngineerDialog.divisionsAdapter
		}
	...
	fun open(cuCredentials: Credentials, profile: User, divisions: List<Division>) {
		this@RegistrationEngineerDialog.profile = profile
