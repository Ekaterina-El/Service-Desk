...
class ReportRequestsByDivisions : ReportBaseFragment() {
	...
	override fun onCreateView(
		...
		binding = ReportQueryByDivisionsFragmentBinding.inflate(layoutInflater, container, false)
		binding.apply {
			lifecycleOwner = viewLifecycleOwner
			master = this@ReportRequestsByDivisions
			viewModel = this@ReportRequestsByDivisions.reportViewModel
			accidentsAdapter = this@ReportRequestsByDivisions.accidentsAdapter
		}
